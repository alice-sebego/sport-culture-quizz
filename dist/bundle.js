...
/* harmony export */   "default": () => (/* binding */ HandleForm)
/* harmony export */ });
...
var HandleForm = /*#__PURE__*/function () {
  function HandleForm(form, fieldsets, resultDisplay, goodAnswers, userAnswers, score, resultDiv, gifGoodAnswers) {
    _classCallCheck(this, HandleForm);

    this._form = form, this._fieldsets = fieldsets, this._resultDisplay = resultDisplay, this.goodAnswers = goodAnswers, this.userAnswers = userAnswers, this.score = score, this._resultDiv = resultDiv, this._gifGoodAnswers = gifGoodAnswers;
  }

  _createClass(HandleForm, [{
    key: "checkResult",
    value: function checkResult() {
      for (var i = 0; i < this._fieldsets.length; i++) {
    ...
    key: "displayMissingAnswer",
    value: function displayMissingAnswer() {
      var missingAnswer = document.createElement("div");
    ...
    value: function displayResult() {
      this.result = this.score.filter(function (userScore) {
        return userScore !== true;
      }).length;
    ...
    key: "handleDisplayAnswer",
    value: function handleDisplayAnswer() {
      var _this = this;

      var _loop = function _loop(i) {
        if (_this.score[i] === true) {
          _this._fieldsets[i].style.backgroundColor = "#a3e9f2";
        } else {
          _this._fieldsets[i].style.backgroundColor = "#f4acac";

          _this._fieldsets[i].classList.add("echec");

          setTimeout(function () {
            _this._fieldsets[i].classList.remove("echec");
          }, 500);
        }
      };
    ...
    value: function submitEvent() {
      ...
      this._form.addEventListener("submit", function (e) {
        ...
        for (var i = 1; i < _this2._fieldsets.length + 1; i++) {
          if (!document.querySelector("input[name=\"q".concat(i, "\"]:checked"))) {
            _this2.displayMissingAnswer();

            return;
          } else {
            _this2.userAnswers.push(document.querySelector("input[name=\"q".concat(i, "\"]:checked")).value);
          }
        }
    ...
    key: "clickAnswer",
    value: function clickAnswer(color) {
...
/* harmony export */ });
var gifGoodAnswers = ["https://media.giphy.com/media/O6JIc2aWjFPBm/giphy.gif", "https://media.giphy.com/media/9Y1BfGEG29BVrNZyBX/giphy.gif", "https://media.giphy.com/media/kVVepXkGDA4W7fiBMA/giphy.gif", "https://media.giphy.com/media/l2LoQadL5f2k2i0Yxl/giphy.gif", "https://media.giphy.com/media/fZ7ncxVECeVuSrRnJb/giphy.gif", "https://media.giphy.com/media/jReQBI5z2uqTmGZ9Es/giphy.gif"];
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (gifGoodAnswers);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _handle_form_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(332);
/* harmony import */ var _gif_list_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(333);
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(334);
...
var $result = document.getElementById("result"); // Arrays which we need to have in order to compare the user's answers and true answers 

var goodAnswers = ["a", "b", "d", "d", "a"];
var userAnswers = [];
...
$year.textContent = _utils_js__WEBPACK_IMPORTED_MODULE_2__.year.getUTCFullYear();
})();
